...
# scope="module" means it is run only once – when the test file is executed
# and isn’t invoked on every function call
...
@pytest.mark.asyncio
async def test_event_post(default_client: httpx.AsyncClient, access_token: str) -> None:
    payload = {
        "title": "FastAPI Book Launch",
        "image": "https://linktomyimage.com/image.png",
        "description": "We will be discussing the contents of the FastAPI book in this event.Ensure to come with your own copy to win gifts!",
